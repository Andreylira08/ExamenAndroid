...
fun SearchTab(
    ...
    Column(
        ...
        val filteredCountries = remember(searchQuery, uiState.countryList) {
            if (searchQuery.isEmpty()) {
                emptyList()
            } else {
                uiState.countryList.filter { country ->
                    country.name.contains(searchQuery, ignoreCase = true) ||
                            country.official.contains(searchQuery, ignoreCase = true) ||
            ...
            searchQuery.isEmpty() -> {
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Search by name, official name or capital",
            ...
            filteredCountries.isEmpty() -> {
                ...
                LazyVerticalGrid(
                    ...
                    items(
                        ...
                        key = { filteredCountries[it].name },
                    ) { index ->
                        CountryCard(
                            country = filteredCountries[index],
                            onClick = { onCountryClick(filteredCountries[index].name) },
                        )
                    }
                }
            }
